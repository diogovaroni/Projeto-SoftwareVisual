...
namespace RegistroVendas.Controllers
{
    public class VendedoresController : Controller
    {
        ...
        public VendedoresController(RegistroVendasContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Email,CPF,BaseSalarial")] Vendedor vendedor)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Email,CPF,BaseSalarial")] Vendedor vendedor)
        {
            if (id != vendedor.Id)
            {
                return NotFound();
